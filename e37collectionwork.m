...
minr = dis(rspheres(1,1),rspheres(1,2),rspheres(1,3),reallines(1,pse),reallines(2,pse),reallines(3,pse));
    for tsp=1:testcolom(1)
        if rspheres(tsp,4)-0.001<=minr
            minr = rspheres(tsp,4);
%             dis(rspheres(tsp,1),rspheres(tsp,2),rspheres(tsp,3),reallines(1,pse),reallines(2,pse),reallines(3,pse));
